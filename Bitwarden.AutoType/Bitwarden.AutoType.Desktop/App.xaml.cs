...
#pragma warning restore CS8622 // Nullability of reference types in type of parameter doesn't match the target delegate (possibly because of nullability attributes).
        ...
        .ConfigureUserLocalAppDataJsonFile(BitwardenConstants.DefaultDataFolderName, "client.settings.json",
            out BitwardenClientConfiguration? clientSettings, out Action<BitwardenClientConfiguration>? saveClientSettingsToFile, false)
        .ConfigureUserLocalAppDataJsonFile(BitwardenConstants.DefaultDataFolderName, "autotype.settings.json",
            out AutoTypeSettings? autoTypeSettings, out Action<AutoTypeSettings>? autoTypeSaveSettingsToFile, false)
        .ConfigureUserLocalAppDataJsonFile(BitwardenConstants.DefaultDataFolderName, "backup.settings.json",
            out BackupSettings? backupSettings, out Action<BackupSettings>? saveBackupSettingsToFile, false)
