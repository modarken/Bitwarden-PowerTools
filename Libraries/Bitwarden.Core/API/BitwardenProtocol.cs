...
public static class BitwardenProtocol
{
    ...
    public static async Task<PreLoginResponse?> PostPreLogin(string baseAddress, string email, bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
    ...
    public static async Task<TokenResponse?> PostAccessTokenFromAPIKey(string baseAddress, string clientID, string clientSecret, string deviceName = "", string deviceIdentifier = "", bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
    ...
    public static async Task<TokenResponse?> PostAccessTokenFromRefreshToken(string baseAddress, string refreshToken, string deviceName = "", string deviceIdentifier = "", bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
    ...
    public static async Task<TokenResponse?> PostAccessTokenFromMasterPasswordHash(string baseAddress, string username, string masterPasswordHash, string deviceIdentifier = "",
        string deviceName = "", bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
    ...
    public static async Task<string?> GetRevisionDate(string baseAddress, string? bearerToken, bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
    ...
    public static async Task<ProfileResponse?> GetProfile(string baseAddress, string? bearerToken, bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
     ...
     public static async Task<SyncResponse?> GetSync(string baseAddress, string? bearerToken, bool allowInvalidCertificates = true)
    {
        try
        {
            var api = BitwardenApiFactory.GetApi(baseAddress, allowInvalidCertificates);
